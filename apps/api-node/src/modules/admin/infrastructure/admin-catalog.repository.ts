import type { AdminArea, AdminBuilding, AdminCatalogRepository, AdminCatalogStats, AdminCategory, AdminHandoverPoint } from "../application/admin-catalog.repository.port.js";

export type { AdminArea, AdminBuilding, AdminCatalogRepository, AdminCatalogStats, AdminCategory, AdminHandoverPoint } from "../application/admin-catalog.repository.port.js";
...
export function createAdminCatalogRepository(pool: SqlExecutor) {
  ...
  } satisfies AdminCatalogRepository;
