...
import { mediaPolicy } from "../../../../shared/domain/media.js";
...
import type { ClaimController } from "./claim.controller.js";

export function createClaimRoutes({ claimController, auth }: {
