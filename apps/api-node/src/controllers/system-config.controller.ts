...
import { configHistoryQuerySchema, configIdParamSchema, createConfigSchema, listConfigsQuerySchema, updateConfigSchema } from "../validators/system-config.validator.js";
