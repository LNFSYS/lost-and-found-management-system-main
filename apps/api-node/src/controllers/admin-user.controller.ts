...
export const adminUserController = {
  ...
  async createUser(request: Request, response: Response) {
    response.status(201).json(await adminUserService.createUser(createAdminUserSchema.parse(request.body)));
  },

  async updateUser(request: Request, response: Response) {
    response.json(await adminUserService.updateUser(routeId(request), updateAdminUserSchema.parse(request.body)));
  },
  ...
  async deleteUser(request: Request, response: Response) {
    await adminUserService.deleteUser(actorId(request), routeId(request));
