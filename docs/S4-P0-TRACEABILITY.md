...
| One claimant/finder participant set | `migrations/045_peer_claim_conversations.sql`, `repositories/claim.repository.ts` | Role/user unique keys, server-derived Finder, participant membership checks |
